...
//张杰华修改@2016-06-23
#define BTNGLOBALSTYLE "QPushButton{outline: 0px;}""QPushButton:focus{border: 2px solid blue;outline: 5px;}"
#define CHECKGLOBALSTYLE 	"QCheckBox::indicator:unchecked {image: url(:/weiduodianzi/ui/signalflag0.png);}""QCheckBox::indicator:checked {image: url(:/weiduodianzi/ui/signalflag1.png);}""QCheckBox:focus{border: 2px solid blue;outline: 5px;}"
